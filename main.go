...
type CLI struct {
	...
	Exec      execCmd      `cmd:"" help:"Exec axis: run M against the namespace (load / run / eval / abort)."`
	Data      dataCmd      `cmd:"" help:"Data axis: globals for fixtures + inspection (get / set / kill / query)."`
